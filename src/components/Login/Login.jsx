          ...
          <div className="card-body p-3 p-md-4 p-xl-5">
            <div className="row">
              <div className="col-12">
                <div className="mb-4">
                  <h2 className="h3 secondry-color">Login</h2>
            ...
            <div className="row">
              <div className="col-12">
                <div className="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                  <p className="m-0 text-secondary text-center">Dont have an account? <a href="#!" className="link-primary text-decoration-none">Register</a></p>
                </div>
              </div>
            </div>
